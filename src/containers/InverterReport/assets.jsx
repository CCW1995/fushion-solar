// Inverter Report data structure for reference
export const inverterReportDataStructure = {
  plant_name: 'Plant name',
  address: 'Plant address/location',
  pv_yield: 'PV system yield in kWh',
  inverter_yield: 'Inverter output in kWh',
...
export const filterOptions = {
  ...
  dimension: [
    ...
    { value: 'By inverter', label: 'By inverter' },
...
export const tableColumns = {
  ...
  inverterYield: { width: 180, sorter: true },
