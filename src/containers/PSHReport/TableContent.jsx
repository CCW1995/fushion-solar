...
function TableContent({
  ...
  React.useEffect(() => {
    if (stationName && pshReportData && pshReportData.length > 0 && hasSearched) {
      const chartData = pshReportData.map(item => ({
  ...
  return (
    <>
              ...
              <div className="search-filters">
                <Row gutter={[16, 16]} align="bottom">
                  ...
                  <Col span={24} style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
                    ...
                    <Button type="default" onClick={() => exportPSHReport({
                      inverterBrand: brand,
                      stationName,
                      classification,
                      period: selectedPeriod.toLowerCase(),
      ...
      {/* Table and Chart Section - Side by side when chart is shown */}
      <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
        {/* Table Column */}
        <Col xs={24} lg={showChart ? 12 : 24} className="white-background-panel">
          <div className="psh-report-panel">
            <Table 
              ...
              pagination={{
                ...
                showTotal: (total) => `Total: ${pshReportMeta?.itemCount || 0}`
              }}
        ...
        {showChart && chartData.length > 0 && (
          <Col xs={24} lg={12} className="white-background-panel">
            <Card style={{ marginTop: 0, backgroundColor: 'white' }}>
                {
                  !loading && (
                  <ResponsiveContainer width="100%" height={400}>
                    ...
                    >
                      ...
                      <ReferenceLine 
                        ...
                        stroke="red" 
                        strokeDasharray="5 5" 
                        label={{ value: "Threshold (3.2)", position: "topRight" }}
                      />
                    </LineChart>
                  </ResponsiveContainer>
                )
